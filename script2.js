document.addEventListener("DOMContentLoaded", () => {
  ...
  ScrollTrigger.create({
    ...
    onUpdate: (self) => {
      ...
      // Search bar opacity toggle
      if (progress >= 0.5) {
        gsap.set(".searchBar", { opacity: 1 });
      } else {
        gsap.set(".searchBar", { opacity: 0 });
      }
      ...
      if (progress >= 0.5 && progress <= 0.75) {
        ...
        gsap.set(".searchBar p", { opacity: 0 });
      ...
      if (progress >= 0.75) {
        ...
        gsap.set(".searchBar p", { opacity: finalHeaderProgress });
